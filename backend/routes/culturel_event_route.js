...
const Account = require("../models/culturel_event_schema");
const router = express.Router();

router.post("/", async (req, res) => {
  try {
    const { name, type, date, time, location, seats, desc } = req.body;
    ...
    const newAccount = new Account({ name, type, date, time, location, seats, desc });
